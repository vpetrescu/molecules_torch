...
parameters.nhiddens2 = {type = 'int', min = 40, max = 310}
...
local scientist = whetlab('BoB fine025 2 layers', 'is nan not ignored', parameters, outcome, True,'a6cea373-547c-4810-9023-32de11d09012')
