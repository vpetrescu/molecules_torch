...
local scientist = whetlab('Sorted C Triplets', 'is nan ignored as well', parameters, outcome, True,'a6cea373-547c-4810-9023-32de11d09012')
local job = scientist:suggest()
for ei = 1,200 do
    print 'trail number'
    print(ei)
    job = scientist:suggest()
    valid_accuracy = run_neural_net(job.nhiddens1, job.nhiddens2,  job.learning_rate, 'none', job.activation)
