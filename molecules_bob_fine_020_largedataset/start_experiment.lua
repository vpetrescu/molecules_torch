...
parameters.nhiddens2 = {type = 'int', min = 10, max = 200}
...
local scientist = whetlab('BoB fine020 2 layers largedataset', 'is nan  ignored', parameters, outcome, True,'a6cea373-547c-4810-9023-32de11d09012')
