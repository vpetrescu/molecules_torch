...
opt.batchSize = 5-- 'mini-batch size (1 = pure stochastic)')
opt.weightDecay = 1e-6 -- 'weight decay (SGD only)')
...
data_filename = 'desc_BoB-20-fine020-noisy-10'
avg_rmse = 0
...
for fold_nbr=1,5 do
    ...
    for epoch_id = 1,600 do
        ...
        test_rmse, train_rmse = test(epoch_id)
