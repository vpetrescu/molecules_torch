...
local parameters = {}
parameters.nhiddens1 = {type = 'int', min = 40, max = 450}
parameters.nhiddens2 = {type = 'int', min = 40, max = 510}
...
local scientist = whetlab('BoB-fine001-2layers', 'Hopefully correct dataset', parameters, outcome, True,'a6cea373-547c-4810-9023-32de11d09012')
