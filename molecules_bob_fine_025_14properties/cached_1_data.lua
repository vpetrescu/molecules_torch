...
for fold_id, value in pairs(train_bucket_indices_set) do
    local fullfilename = '../../data14properties/test_'..base_filename..'_fold_'..tonumber(fold_id)..'.mat'
