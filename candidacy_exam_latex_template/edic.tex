...
According to the type of data available (labeled and/or unlabeled) there are a number of frameworks in machine learning
\begin{itemize}
...
Self thaught learning can be expressed as a two part optimization problem.
...
\begin{array}{c }
	...
	\end{array}
\end{equation}
The equation above can be easily optimized using the algorithm from citehere by alternating the optimizating a and b, e.g. fix one variable and optimize the other one at every step.
